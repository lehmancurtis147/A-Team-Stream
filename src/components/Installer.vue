<template>
<div id="v-stepper" class="d-flex flex-column flex-grow-1">
  <v-stepper
    ref="stepper"
    height="auto"
    v-model="curStep"
  ...
  >
    ...
    >
      <v-card>
        ...
        <v-card-text>
          <p>
            On Linux, users aren’t allowed to access USB devices by default.
          </p>
          <p>
            ...
            >
              <v-list-item-content>
                <v-list-item-title>Arch Linux</v-list-item-title>
                  <v-list-item-subtitle >sudo pacman -S android-udev</v-list-item-subtitle >
              </v-list-item-content>
            </v-list-item>
            ...
            >
              <v-list-item-content>
                <v-list-item-title >Debian, Ubuntu</v-list-item-title >
                  <v-list-item-subtitle >sudo apt install android-sdk-platform-tools-common</v-list-item-subtitle >
              </v-list-item-content>
            </v-list-item>
            ...
            >
              <v-list-item-content>
                <v-list-item-title >Other distributions</v-list-item-title >
                  <v-list-item-subtitle >Instructions vary</v-list-item-subtitle >
              </v-list-item-content>
            </v-list-item>

              <p>
                Once you’ve installed udev rules, unplug your device and plug it back in for it to take effect.
              </p>
        </v-card-text>
    ...
    >
      <v-card>
        ...
        >
          ...
          <v-card-text>
            <p>
              Another app is taking control of your device, so we can’t talk to it.
            </p>
            <p>
              This is usually caused by having this installer open in another browser tab.
            </p>
            <p>
              To fix this, close all other web installer tabs in your browser and make sure you don’t have any tabs remaining in other windows.
            </p>
          </v-card-text>
    ...
    >
      <v-card>
        ...
        >
          ...
          <v-card-text>
            <p>
              Your device disconnected, so we can’t continue installing.
            </p>
            <p>
              To fix this:
              <ul
      ...
      <v-card>
        ...
        Out of storage
          ...
          <v-card-text>
            ...
            <p>
              If you’re not low on storage, this is caused by using an incognito window or guest browser profile. These profiles have very storage limits, so installing from
              them isn’t possible.
            </p>
            <p>
              To fix this,
    ...
    >
      <v-card>
        ...
        Out of memory
          ...
          <v-card-text>
            <p>
              There isn’t enough free memory (RAM) to unpack and install the OS.
            </p>
            <p>
              To fix this,
              <strong>close some unused apps</strong>
              and try again.
            </p>
            <p>
              If it still doesn’t work, you may need to install from another computer or device with more memory.
            </p>
          </v-card-text>
      ...
      <v-card>
        ...
        Device is stuck
          ...
          <v-card-text>
            ...
            <p>
              To fix this, use the volume buttons to highlight
              <strong>“Restart bootloader”</strong>
              in the bootloader menu, and press the power button to select it.
            </p>
          </v-card-text>
  ...
  methods: {
    ...
    async retryDisconnect () {
      ...
      try {
        ...
        const [handled, message] = this.bubbleError(e, this.retryDisconnect)
