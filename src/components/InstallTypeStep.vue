  ...
  >
    ...
    >
      ...
      >
        <p>
          ...
          {{ $root.$data.OS_NAME }} or switch to it from another OS, but you
          need to choose which one you want.
        </p>
      </div>
    </div>
    ...
    >
      <v-card
        outlined
        max-width="16rem"
        class="container text-h4 ma-4 d-flex flex-column"
        ripple
      ...
      >
        ...
        <v-card-subtitle>
          Switch from the stock OS or another ROM to {{ $root.$data.OS_NAME }}.
          <strong
      ...
      <v-card
        max-width="16rem"
        class="container text-h4 ma-4 d-flex flex-column justify-space-between"
        ripple
      ...
      >
        <div>
          ...
          <v-card-subtitle>
            Update from an older version of {{ $root.$data.OS_NAME }}. Your
